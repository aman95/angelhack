...
import hackathon.angelhack.fragment.BuyBooks;
import hackathon.angelhack.fragment.Circles;
import hackathon.angelhack.fragment.SellBooks;
//import com.parse.ParseUser;
        ...
        switch (position) {
            case 0: {
                fragmentManager.beginTransaction()
                        .replace(R.id.containerFragment, SellBooks.newInstance(position, name))
                        .commit();
            ...
            case 1: {
                fragmentManager.beginTransaction()
                        .replace(R.id.containerFragment, BuyBooks.newInstance(position, name))
                        .commit();
